                ...
                <div class="premium-border bg-velora-surface p-8 sm:p-12 rounded-3xl reveal">
                    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                        ...
                        <div class="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-6 bg-velora-bg p-6 sm:p-8 rounded-2xl border-none">
                            <div>
                                <h3 class="text-xs font-bold uppercase tracking-widest text-emerald-500 mb-3">What's Included</h3>
                            ...
                            <div>
                                <h3 class="text-xs font-bold uppercase tracking-widest text-velora-accent mb-3">Ideal For</h3>
...
function renderContactPage() {
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div>
                            ...
                            <select id="industry" name="industry" class="w-full bg-transparent border-b border-velora-borderStrong px-0 py-2.5 text-base md:text-sm text-velora-text focus:outline-none input-luxury">
                                ...
                                <option value="restaurants" class="bg-velora-surface text-velora-text">Restaurants & Hospitality</option>
                                <option value="clinics" class="bg-velora-surface text-velora-text">Clinics & Dentists</option>
                                <option value="salons" class="bg-velora-surface text-velora-text">Salons & Wellness</option>
    ...
    const script = `
        ...
        if (industrySelect && industryParam) {
            const normIndustry = { 'restaurant': 'restaurants', 'clinic': 'clinics', 'salon': 'salons' }[industryParam] || industryParam;
            for (let i = 0; i < industrySelect.options.length; i++) {
                if (industrySelect.options[i].value === normIndustry || industrySelect.options[i].value === industryParam) {
